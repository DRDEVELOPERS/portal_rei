// app/components/sections/RecentlyViewed.js
"use client";
...
export default function RecentlyViewed({ products }) {
  ...
  useEffect(() => {
    ...
    setViewedProducts(savedViews);
  }, []);

  // Filter products to only include viewed IDs
  const filteredProducts = products.filter((product) =>
    viewedProducts.includes(product.id.toString())
  );
