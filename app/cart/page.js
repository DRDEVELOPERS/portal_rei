        ...
        <ClientOnly>
          {cart.getCart().length === 0 ? (
            <div id="emptyCart" className="text-center py-24 animate__animated">
              <div className="text-3xl mb-4">🛒 Your cart is empty</div>
              <button
                onClick={() => router.push("/")}
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {/* Cart Items */}
              <div id="cartItems" className="lg:col-span-2 space-y-6 animate__animated">
              ...
              <div className="lg:sticky lg:top-24 h-fit">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 
                  ...
                  <div className="mb-6">
                    <div className="h-2 bg-gray-100 rounded-full mb-2">
                      <div 
                        ...
                        style={{ width: `${Math.min((cart.cartTotal() / 10000) * 100, 100)}%` }}
                      />
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {cart.cartTotal() < 10000 ? (
                        <>Add £{(10000 - cart.cartTotal())/100} more for free shipping!</>
                      ) : (
                        <span className="text-green-500">🎉 Free shipping unlocked!</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">£{(cart.cartTotal() / 100).toFixed(2)}</span>
                    </div>
                ...
                <div className="mt-6 bg-primary-yellow/10 p-6 rounded-xl animate__animated animate__fadeIn">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <button className="bg-primary-black text-white px-6 py-2 rounded-lg
